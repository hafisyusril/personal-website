        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="md:col-span-2 space-y-10 text-[#D6E1FF]">
            <div>
              ...
              <p>
                Blu by BCA aimed to modernize its digital banking platform to
                improve accessibility and user experience across all devices.
              </p>
            </div>
            <div>
              <h2 className="text-2xl font-bold text-green-500 mb-2">Task</h2>
              <p>
                I was responsible for developing a clean, responsive frontend
                and integrating it seamlessly with backend services for
            ...
            <div>
              ...
              <p>
                Using Next.js and Tailwind CSS, I implemented responsive UI
                components and optimized loading performance. I also set up API
                integrations for transactional features.
              </p>
            </div>
            <div>
              <h2 className="text-2xl font-bold text-green-500 mb-2">Result</h2>
              <p>
                The improved platform delivered faster load times and a more
                intuitive user interface, increasing user satisfaction and
                session duration.
              </p>
            </div>
          </div>
