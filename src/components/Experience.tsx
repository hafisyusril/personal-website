      ...
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
        ...
        <li>
          ...
          <div className="timeline-end md:mb-10">
            <time className="text-sm text-gray-400 mb-1">1998</time>
            <div className="text-2xl font-semibold text-green-500 mb-3">
              iMac
            </div>
            <h3 className="text-lg font-semibold text-[#D6E1FF] mb-3">
        ...
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            <time className="text-sm text-gray-400 mb-1">2001</time>
            <div className="text-2xl font-semibold text-green-500 mb-3">
              iPod
            </div>
            <h3 className="text-lg font-semibold text-[#D6E1FF] mb-3">
        ...
        <li>
          ...
          <div className="timeline-end md:mb-10">
            <time className="text-sm text-gray-400 mb-1">2007</time>
            <div className="text-2xl font-semibold text-green-500 mb-3">
              iPhone
            </div>
            <h3 className="text-lg font-semibold text-[#D6E1FF] mb-3">
        ...
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            <time className="text-sm text-gray-400 mb-1">2015</time>
            <div className="text-2xl font-semibold text-green-500 mb-3">
              Apple Watch
            </div>
            <h3 className="text-lg font-semibold text-[#D6E1FF] mb-3">
